...
\gray           &  {\textit{
    ...
    %% My biggest achivement on this project is
...
%% I have developed a reagent/re-frame UI for QA, an asynchronous http-gateway to our messaging applications, worked on various parts of a BPMN engine and a microservices application
%% Our ever-evolving
}}\\ \\
...
%% \gray Languages & SQL\\
%% \gray           & {\textit{Navigation and map data solutions.}} \\ \\
